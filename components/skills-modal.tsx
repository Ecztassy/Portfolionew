        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-3xl bg-black border border-green-400/30 p-6 overflow-hidden h-[50vh]"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close button stays absolutely positioned */}
              <button
                onClick={onClose}
              ...
              {/* Content wrapper with flex centering and scrollbar hidden */}
              <div className="relative flex flex-col items-center h-full overflow-auto px-8 modal-scrollbar-hide">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="mt-6 font-mono text-xs text-green-400/40 border-t border-green-400/20 pt-4">
                      <div className="mb-1">{">"} {t("skills.profileLoaded")}</div>
                      <div>{">"} {t("skills.connectionSecure")}</div>
                    </div>
                  </motion.div>
                </AnimatePresence>
              </div>
